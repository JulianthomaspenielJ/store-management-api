        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="progress mt-3">
                <div class="progress-bar" role="progressbar" style={{width:"50px"}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div class="progress mt-3">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="progress mt-3">
                <div class="progress-bar" role="progressbar" style={{width:"50px"}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50%</div>
              </div>
              <div class="progress mt-3">
