...
class LOGINMODEL extends APIRESPONSE
{
    ...
    private function loginCheck($request)
    {
        try {
            ...
            if ($request['loginType'] === "user") {
                $query = "SELECT name, password, id,role_id FROM tbl_users";
            ...
            $roles = $this->getUserRoles($data['role_id']);
            ...
            // UPDATE tbl_loss SET invoice_number = '" . $data['invoiceNumber'] . "', loss_date = '" . $data['lossDate'] . "',vendor_name = '" . $data['vendorName'] . "', city = '" . $data['city'] . "', product_type = '" . $data['productType'] . "', product_quantity = '" . $data['productQuantity'] . "', 	unit = '" . $data['unit'] . "', amount = '" . $data['amount'] . "',updated_by = '" . $loginData['id'] . "',updated_date = '$dateNow' WHERE id = " . $data['id'] . "";
            $sqlInsert = "UPDATE tbl_users SET token= '" . $token . "' WHERE id = " . $data['id'] . "";
    ...
    public function getUserRoles($id)
    {
        try {
            ...
            $querySdfd = "SELECT role_name,id FROM  tbl_roles  WHERE id = '$id'";
    ...
    public function tokenCheck($token = "")
    {
        ...
        try {
            ...
            $query = "SELECT u.id,u.email_id,r.role_name FROM tbl_users u
